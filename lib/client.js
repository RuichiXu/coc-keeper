...
`
			...
			function mountPanel() {
				...
				function renderNetContent(box, dp, meta) {
					...
					var model = createNetModel(dp, netDigest), cache = new Map(), view, camera, filterTimer;
					...
					function draw() {
						...
						if (!cache.has(NET_UI.layout)) cache.set(NET_UI.layout, createNetLayout(dp, netDigest, NET_UI.layout));
