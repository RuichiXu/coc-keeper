...
import { ASSET_KINDS, KNOWLEDGE_LAYERS, applyStructureEdits, buildKnowledgeView, canonicalizeDeepParse, compileByPattern, computeStoryFrontier, detectDeadEndScenes, ensureScenarioContract, extractCheckpoints, extractSceneFacts, extractStoryIntro, mergeDeepParseDraft, normalizeScenarioContract, sanitizeMetaText, storyFrontierText, validateDeepParse } from "../../core/index.js";
    ...
    if (req.method === "POST") {
      ...
      if (path === "/coc-api/deep-parse") {
        ...
        const sourceDp = ownAsset
          ? (asset !== null && asset.deepParse !== null && asset.deepParse !== undefined ? asset.deepParse : flat.deepParse)
      ...
      if (path === "/coc-api/game-setup") {
        ...
        if (scenarioId.length > 0) {
          ...
          if (asset.deepParse !== undefined && asset.deepParse !== null) {
            flat.deepParse = asset.deepParse;
          }
        }
